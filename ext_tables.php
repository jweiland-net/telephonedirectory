...
\TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerPlugin('JWeiland.' . $_EXTKEY, 'Telephone', 'Telephone: Main');

\TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerPlugin('JWeiland.' . $_EXTKEY, 'Interpreter',
    'Telephone: Interpreter');

\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile($_EXTKEY, 'Configuration/TypoScript',
    'Telephone Directory');

\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_telephonedirectory_domain_model_employee',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_telephonedirectory_domain_model_office',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_telephonedirectory_domain_model_building',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_telephonedirectory_domain_model_department',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_telephonedirectory_domain_model_languageskill',
