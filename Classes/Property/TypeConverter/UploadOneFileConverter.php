...
class UploadOneFileConverter extends AbstractTypeConverter
{
    ...
    public function convertFrom(
        ...
        if ($source['error'] !== 0) {
            return new Error(
                LocalizationUtility::translate('error.upload', 'telephonedirectory') . $source['error'],
                1396957314
            );
        }
    ...
    {
        // upload file
        $uploadFolder = ResourceFactory::getInstance()->retrieveFileOrFolderObject('uploads/tx_telephonedirectory/');
